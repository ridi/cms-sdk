...
class AdminMenuService_getMenuList_result {
  static $_TSPEC;
  ...
  public function getName() {
    return 'AdminMenuService_getMenuList_result';
  }
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem5 = null;
              $elem5 = new \Ridibooks\Cms\Thrift\AdminMenu\AdminMenu();
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('AdminMenuService_getMenuList_result');

...
class AdminUserService_getUser_result {
  static $_TSPEC;
  ...
  public function getName() {
    return 'AdminUserService_getUser_result';
  }
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::STRUCT) {
            $this->success = new \Ridibooks\Cms\Thrift\AdminUser\AdminUser();
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('AdminUserService_getUser_result');

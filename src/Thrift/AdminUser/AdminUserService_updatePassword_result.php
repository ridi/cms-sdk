...
class AdminUserService_updatePassword_result {
  static $_TSPEC;
  ...
  public function getName() {
    return 'AdminUserService_updatePassword_result';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('AdminUserService_updatePassword_result');

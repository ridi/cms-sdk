...
class AdminUserService_getAllUserIds_result {
  static $_TSPEC;
  ...
  public function getName() {
    return 'AdminUserService_getAllUserIds_result';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('AdminUserService_getAllUserIds_result');

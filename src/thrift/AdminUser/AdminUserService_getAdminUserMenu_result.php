...
class AdminUserService_getAdminUserMenu_result {
  static $_TSPEC;
  ...
  public function getName() {
    return 'AdminUserService_getAdminUserMenu_result';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('AdminUserService_getAdminUserMenu_result');

...
class AdminMenuService_getMenus_result {
  static $_TSPEC;
  ...
  public function getName() {
    return 'AdminMenuService_getMenus_result';
  }
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem33 = null;
              $elem33 = new \Ridibooks\Cms\Thrift\AdminMenu\AdminMenu();
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('AdminMenuService_getMenus_result');

...
class AdminTagService_getAdminTagMenus_args {
  static $_TSPEC;
  ...
  public function getName() {
    return 'AdminTagService_getAdminTagMenus_args';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('AdminTagService_getAdminTagMenus_args');
    if ($this->tag_id !== null) {

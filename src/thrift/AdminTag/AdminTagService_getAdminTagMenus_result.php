...
class AdminTagService_getAdminTagMenus_result {
  static $_TSPEC;
  ...
  public function getName() {
    return 'AdminTagService_getAdminTagMenus_result';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('AdminTagService_getAdminTagMenus_result');

...
var _AdminAuthService = require('./thrift/AdminAuthService');

var _AdminAuthService2 = _interopRequireDefault(_AdminAuthService);
...
var CmsClient = function CmsClient() {
  ...
  this.adminAuth = new _ClientWrapper2.default('AdminAuth', _AdminAuthService2.default, connection);

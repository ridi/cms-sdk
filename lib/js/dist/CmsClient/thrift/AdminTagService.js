...
var AdminTagService_getAdminTag_args = function AdminTagService_getAdminTag_args(args) {
  this.tag_id = null;
  if (args) {
    if (args.tag_id !== undefined && args.tag_id !== null) {
      this.tag_id = args.tag_id;
...
var AdminTagService_getAdminTag_result = function AdminTagService_getAdminTag_result(args) {
  this.success = null;
  this.userException = null;
  this.systemException = null;
  if (args instanceof Errors_ttypes.UserException) {
...
var AdminTagService_getAdminTags_args = function AdminTagService_getAdminTags_args(args) {
  this.tag_ids = null;
  if (args) {
    if (args.tag_ids !== undefined && args.tag_ids !== null) {
      this.tag_ids = Thrift.copyList(args.tag_ids, [null]);
...
var AdminTagService_getAdminTags_result = function AdminTagService_getAdminTags_result(args) {
  this.success = null;
  this.userException = null;
  this.systemException = null;
  if (args instanceof Errors_ttypes.UserException) {
...
AdminTagServiceProcessor.prototype.process_getAdminTag = function (seqid, input, output) {
  ...
  if (this._handler.getAdminTag.length === 1) {
    Q.fcall(this._handler.getAdminTag, args.tag_id).then(function (result) {
...
AdminTagServiceProcessor.prototype.process_getAdminTags = function (seqid, input, output) {
  ...
  if (this._handler.getAdminTags.length === 1) {
    Q.fcall(this._handler.getAdminTags, args.tag_ids).then(function (result) {

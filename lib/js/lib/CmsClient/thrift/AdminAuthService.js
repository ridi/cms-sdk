...
var AdminAuthService_authorizeTag_args = function(args) {
  this.token = null;
  this.tags = null;
  if (args) {
    if (args.token !== undefined && args.token !== null) {
...
AdminAuthService_authorizeTag_args.prototype = {};
AdminAuthService_authorizeTag_args.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
AdminAuthService_authorizeTag_args.prototype.write = function(output) {
  output.writeStructBegin('AdminAuthService_authorizeTag_args');
  if (this.token !== null && this.token !== undefined) {
    output.writeFieldBegin('token', Thrift.Type.STRING, 1);
    output.writeString(this.token);
    output.writeFieldEnd();
...
var AdminAuthService_authorizeTag_result = function(args) {
  this.systemException = null;
  this.noTokenException = null;
  this.malformedTokenException = null;
  this.expiredTokenException = null;
...
AdminAuthService_authorizeTag_result.prototype = {};
AdminAuthService_authorizeTag_result.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
AdminAuthService_authorizeTag_result.prototype.write = function(output) {
  output.writeStructBegin('AdminAuthService_authorizeTag_result');
  if (this.systemException !== null && this.systemException !== undefined) {
    output.writeFieldBegin('systemException', Thrift.Type.STRUCT, 1);
    this.systemException.write(output);
    output.writeFieldEnd();
...
AdminAuthServiceClient.prototype.authorizeTag = function(token, tags, callback) {
  this._seqid = this.new_seqid();
  if (callback === undefined) {
    var _defer = Q.defer();
    this._reqs[this.seqid()] = function(error, result) {
...
AdminAuthServiceClient.prototype.send_authorizeTag = function(token, tags) {
  var output = new this.pClass(this.output);
  output.writeMessageBegin('authorizeTag', Thrift.MessageType.CALL, this.seqid());
  var args = new AdminAuthService_authorizeTag_args();
  args.token = token;
  args.tags = tags;
  args.write(output);
  output.writeMessageEnd();
...
AdminAuthServiceClient.prototype.recv_authorizeTag = function(input,mtype,rseqid) {
  var callback = this._reqs[rseqid] || function() {};
  delete this._reqs[rseqid];
  if (mtype == Thrift.MessageType.EXCEPTION) {
    var x = new Thrift.TApplicationException();
  ...
  var result = new AdminAuthService_authorizeTag_result();
  result.read(input);
  input.readMessageEnd();
...
AdminAuthServiceProcessor.prototype.process_authorizeTag = function(seqid, input, output) {
  var args = new AdminAuthService_authorizeTag_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.authorizeTag.length === 2) {
    Q.fcall(this._handler.authorizeTag, args.token, args.tags)
      .then(function(result) {
        var result_obj = new AdminAuthService_authorizeTag_result({success: result});
        output.writeMessageBegin("authorizeTag", Thrift.MessageType.REPLY, seqid);
        result_obj.write(output);
        output.writeMessageEnd();
        output.flush();
      }, function (err) {
        var result;
        if (err instanceof Errors_ttypes.SystemException || err instanceof Errors_ttypes.NoTokenException || err instanceof Errors_ttypes.MalformedTokenException || err instanceof Errors_ttypes.ExpiredTokenException || err instanceof Errors_ttypes.UnauthorizedException) {
          result = new AdminAuthService_authorizeTag_result(err);
          output.writeMessageBegin("authorizeTag", Thrift.MessageType.REPLY, seqid);
        } else {
          result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
          output.writeMessageBegin("authorizeTag", Thrift.MessageType.EXCEPTION, seqid);
        }
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.authorizeTag(args.token, args.tags, function (err, result) {
      var result_obj;
      if ((err === null || typeof err === 'undefined') || err instanceof Errors_ttypes.SystemException || err instanceof Errors_ttypes.NoTokenException || err instanceof Errors_ttypes.MalformedTokenException || err instanceof Errors_ttypes.ExpiredTokenException || err instanceof Errors_ttypes.UnauthorizedException) {
        result_obj = new AdminAuthService_authorizeTag_result((err !== null || typeof err === 'undefined') ? err : {success: result});
        output.writeMessageBegin("authorizeTag", Thrift.MessageType.REPLY, seqid);
      } else {
        result_obj = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
        output.writeMessageBegin("authorizeTag", Thrift.MessageType.EXCEPTION, seqid);

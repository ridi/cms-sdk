...
var AdminAuthService_hasUrlAuth_args = function(args) {
  this.method = null;
  this.checkUrl = null;
  this.adminId = null;
  if (args) {
...
AdminAuthService_hasUrlAuth_args.prototype = {};
AdminAuthService_hasUrlAuth_args.prototype.read = function(input) {
...
AdminAuthService_hasUrlAuth_args.prototype.write = function(output) {
  output.writeStructBegin('AdminAuthService_hasUrlAuth_args');
...
var AdminAuthService_hasUrlAuth_result = function(args) {
  this.success = null;
...
AdminAuthService_hasUrlAuth_result.prototype = {};
AdminAuthService_hasUrlAuth_result.prototype.read = function(input) {
  input.readStructBegin();
  while (true)
  {
    var ret = input.readFieldBegin();
...
AdminAuthService_hasUrlAuth_result.prototype.write = function(output) {
  output.writeStructBegin('AdminAuthService_hasUrlAuth_result');
...
AdminAuthServiceClient.prototype.hasUrlAuth = function(method, checkUrl, adminId, callback) {
  ...
  if (callback === undefined) {
    ...
    this.send_hasUrlAuth(method, checkUrl, adminId);
...
AdminAuthServiceClient.prototype.send_hasUrlAuth = function(method, checkUrl, adminId) {
  var output = new this.pClass(this.output);
  output.writeMessageBegin('hasUrlAuth', Thrift.MessageType.CALL, this.seqid());
  var args = new AdminAuthService_hasUrlAuth_args();
  args.method = method;
...
AdminAuthServiceClient.prototype.recv_hasUrlAuth = function(input,mtype,rseqid) {
  ...
  var result = new AdminAuthService_hasUrlAuth_result();
  result.read(input);
  input.readMessageEnd();
  ...
  return callback('hasUrlAuth failed: unknown result');
};
...
AdminAuthServiceClient.prototype.authorize = function(token, method, check_url, callback) {
  this._seqid = this.new_seqid();
  if (callback === undefined) {
    var _defer = Q.defer();
    this._reqs[this.seqid()] = function(error, result) {
...
AdminAuthServiceClient.prototype.send_authorize = function(token, method, check_url) {
  var output = new this.pClass(this.output);
...
;
AdminAuthServiceProcessor.prototype.process_hasUrlAuth = function(seqid, input, output) {
  var args = new AdminAuthService_hasUrlAuth_args();
  args.read(input);
  input.readMessageEnd();
  if (this._handler.hasUrlAuth.length === 3) {
    Q.fcall(this._handler.hasUrlAuth, args.method, args.checkUrl, args.adminId)
      .then(function(result) {
        var result_obj = new AdminAuthService_hasUrlAuth_result({success: result});
        output.writeMessageBegin("hasUrlAuth", Thrift.MessageType.REPLY, seqid);
        ...
        if (err instanceof Errors_ttypes.SystemException || err instanceof Errors_ttypes.UnauthorizedException) {
          result = new AdminAuthService_hasUrlAuth_result(err);
          output.writeMessageBegin("hasUrlAuth", Thrift.MessageType.REPLY, seqid);
        } else {
          result = new Thrift.TApplicationException(Thrift.TApplicationExceptionType.UNKNOWN, err.message);
          output.writeMessageBegin("hasUrlAuth", Thrift.MessageType.EXCEPTION, seqid);
        }
        result.write(output);
        output.writeMessageEnd();
        output.flush();
    ...
    this._handler.hasUrlAuth(args.method, args.checkUrl, args.adminId, function (err, result) {
      var result_obj;
      if ((err === null || typeof err === 'undefined') || err instanceof Errors_ttypes.SystemException || err instanceof Errors_ttypes.UnauthorizedException) {
        result_obj = new AdminAuthService_hasUrlAuth_result((err !== null || typeof err === 'undefined') ? err : {success: result});
        output.writeMessageBegin("hasUrlAuth", Thrift.MessageType.REPLY, seqid);
      } else {
...
AdminAuthServiceProcessor.prototype.process_authorize = function(seqid, input, output) {
  ...
  if (this._handler.authorize.length === 3) {
    Q.fcall(this._handler.authorize, args.token, args.method, args.check_url)
      .then(function(result) {
    ...
    this._handler.authorize(args.token, args.method, args.check_url, function (err, result) {
      var result_obj;

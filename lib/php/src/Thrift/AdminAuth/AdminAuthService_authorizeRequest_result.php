...
class AdminAuthService_authorizeRequest_result {
  static $_TSPEC;
  ...
  public function getName() {
    return 'AdminAuthService_authorizeRequest_result';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('AdminAuthService_authorizeRequest_result');

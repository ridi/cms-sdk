...
class AdminAuthService_introspectToken_result {
  static $_TSPEC;
  ...
  public function getName() {
    return 'AdminAuthService_introspectToken_result';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('AdminAuthService_introspectToken_result');

...
class AdminAuthService_authorizeAdminByTag_result {
  static $_TSPEC;
  ...
  public function getName() {
    return 'AdminAuthService_authorizeAdminByTag_result';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('AdminAuthService_authorizeAdminByTag_result');

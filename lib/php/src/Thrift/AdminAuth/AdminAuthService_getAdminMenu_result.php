...
class AdminAuthService_getAdminMenu_result {
  static $_TSPEC;

  /**
   * @var \Ridibooks\Cms\Thrift\AdminAuth\AdminMenu[]
   */
  public $success = null;
  /**
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        0 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\Ridibooks\Cms\Thrift\AdminAuth\AdminMenu',
            ),
          ),
        1 => array(
          'var' => 'userException',
  ...
  public function getName() {
    return 'AdminAuthService_getAdminMenu_result';
  }
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem12 = null;
              $elem12 = new \Ridibooks\Cms\Thrift\AdminAuth\AdminMenu();
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('AdminAuthService_getAdminMenu_result');

...
class AdminMenuService_getAllMenuList_result {
  static $_TSPEC;
  ...
  public function getName() {
    return 'AdminMenuService_getAllMenuList_result';
  }
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem12 = null;
              $elem12 = new \Ridibooks\Cms\Thrift\AdminMenu\AdminMenu();
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('AdminMenuService_getAllMenuList_result');

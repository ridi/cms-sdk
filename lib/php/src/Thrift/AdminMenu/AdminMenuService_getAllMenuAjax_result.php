...
class AdminMenuService_getAllMenuAjax_result {
  static $_TSPEC;

  /**
   * @var \Ridibooks\Cms\Thrift\AdminMenu\AdminMenuAjax[]
   */
  public $success = null;
  /**
    ...
    if (!isset(self::$_TSPEC)) {
      self::$_TSPEC = array(
        0 => array(
          ...
          'elem' => array(
            'type' => TType::STRUCT,
            'class' => '\Ridibooks\Cms\Thrift\AdminMenu\AdminMenuAjax',
            ),
          ),
        1 => array(
          'var' => 'userException',
  ...
  public function getName() {
    return 'AdminMenuService_getAllMenuAjax_result';
  }
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::LST) {
            ...
            {
              $elem19 = null;
              $elem19 = new \Ridibooks\Cms\Thrift\AdminMenu\AdminMenuAjax();
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('AdminMenuService_getAllMenuAjax_result');

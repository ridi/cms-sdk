...
class AdminTagService_getAdminIdsFromTags_result {
  static $_TSPEC;
  ...
  public function getName() {
    return 'AdminTagService_getAdminIdsFromTags_result';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('AdminTagService_getAdminIdsFromTags_result');

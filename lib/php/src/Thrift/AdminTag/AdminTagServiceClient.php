...
class AdminTagServiceClient implements \Ridibooks\Cms\Thrift\AdminTag\AdminTagServiceIf {
  ...
  public function getAdminTag($tag_id)
  {
    ...
    return $this->recv_getAdminTag();
  }

  public function send_getAdminTag($tag_id)
  {
    ...
    if ($bin_accel)
    {
      thrift_protocol_write_binary($this->output_, 'getAdminTag', TMessageType::CALL, $args, $this->seqid_, $this->output_->isStrictWrite());
    }
    else
    {
      $this->output_->writeMessageBegin('getAdminTag', TMessageType::CALL, $this->seqid_);
      $args->write($this->output_);
      $this->output_->writeMessageEnd();
      $this->output_->getTransport()->flush();
    }
  ...
  public function recv_getAdminTag()
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Ridibooks\Cms\Thrift\AdminTag\AdminTagService_getAdminTag_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;

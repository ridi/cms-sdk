...
class AdminTagService_getAdminTag_result {
  static $_TSPEC;
  ...
  public function getName() {
    return 'AdminTagService_getAdminTag_result';
  }
      ...
      switch ($fid)
      {
        case 0:
          if ($ftype == TType::STRUCT) {
            $this->success = new \Ridibooks\Cms\Thrift\AdminTag\AdminTag();
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('AdminTagService_getAdminTag_result');
